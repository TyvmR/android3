...
public class ImiSpinnerDialogActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.imi_activity_spinner_dialog);
    ...
    private void initSpinnerForDialog() {
        ...
        Spinner sp_dialog = findViewById(R.id.imi_sp_dialog);
    ...
    class MySelectedListener implements OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
            Toast.makeText(ImiSpinnerDialogActivity.this, "您选择的是" + starArray[arg2], Toast.LENGTH_LONG).show();
        }
