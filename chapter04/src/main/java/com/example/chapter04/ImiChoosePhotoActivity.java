...
public class ImiChoosePhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.imi_activity_choose_photo);
        iv_photo = findViewById(R.id.iv_photo);
        findViewById(R.id.imi_btn_choose_common).setOnClickListener(v -> {
        ...
        findViewById(R.id.imi_btn_choose_register).setOnClickListener(v -> launcher.launch("image/*"));
    }
