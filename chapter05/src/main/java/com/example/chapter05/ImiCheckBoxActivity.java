...
public class ImiCheckBoxActivity extends AppCompatActivity
        implements CompoundButton.OnCheckedChangeListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.imi_activity_check_box);
        // 从布局文件中获取名叫ck_system的复选框
        CheckBox ck_system = findViewById(R.id.imi_ck_system);
        // 从布局文件中获取名叫ck_custom的复选框
        CheckBox ck_custom = findViewById(R.id.imi_ck_custom);
    ...
    private class CheckListener implements CompoundButton.OnCheckedChangeListener{
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            Toast.makeText(ImiCheckBoxActivity.this, desc, Toast.LENGTH_LONG).show();
        }
    }
}
